...
public class AboutUs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView=(TextView)rootView.findViewById(R.id.fa_description);
...
//    loading.dismiss();
        ...
        System.out.println("Session id"+new PrefManager(getActivity()).receivedSession());
        //Defining the method
        if (getActivity()!=null) {
            api.otherRequest(new PrefManager(getActivity()).receivedSession(),"2",  //Creating an anonymous callback
