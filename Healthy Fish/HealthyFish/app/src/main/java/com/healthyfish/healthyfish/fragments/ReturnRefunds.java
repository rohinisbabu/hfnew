 ...
 */
public class ReturnRefunds extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_return_refunds, container, false);
        textView = (TextView) rootView.findViewById(R.id.frr_description);
...
//    loading.dismiss();
        ...
        //Defining the method
        if (getActivity() != null) {
            api.otherRequest(new PrefManager(getActivity()).receivedSession(),"4",  //Creating an anonymous callback
