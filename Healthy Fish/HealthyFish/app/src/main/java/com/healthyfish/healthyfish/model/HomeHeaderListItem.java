 ...
 */
public class HomeHeaderListItem implements Serializable {
   String prod_id, mobile_title, malayalam_title,offer_price, actual_price,product_image;
    CustomSpinnerAdapter adapter;


    public HomeHeaderListItem(String prod_id, String mobile_title, String malayalam_title, String offer_price, String actual_price, String product_image, CustomSpinnerAdapter adapter) {
