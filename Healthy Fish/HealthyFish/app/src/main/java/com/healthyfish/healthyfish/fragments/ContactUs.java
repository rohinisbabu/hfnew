...
public class ContactUs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       // return super.onCreateView(inflater, container, savedInstanceState);
        ...
        textView=(TextView)rootView.findViewById(R.id.fcontact_description);
...
//    loading.dismiss();
        ...
        //Defining the method
        if (getActivity()!=null) {
            api.otherRequest(new PrefManager(getActivity()).receivedSession(),"1",  //Creating an anonymous callback
