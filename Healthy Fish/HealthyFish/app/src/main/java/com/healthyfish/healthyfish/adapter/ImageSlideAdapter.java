...
/**
 * Created by RohiniAjith on 6/20/2016.
 */
public class ImageSlideAdapter extends PagerAdapter {
    ...
    Home_Details_Fragment homeFragment;
    ...
    public ImageSlideAdapter(FragmentActivity activity, List<Product> products,
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnFail(R.drawable.ic_fish)
                .showStubImage(R.drawable.ic_fish)
                .showImageForEmptyUri(R.drawable.ic_fish).cacheInMemory()
                .cacheOnDisc().build();
