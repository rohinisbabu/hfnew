...
public class TermsConditions extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView=(TextView)rootView.findViewById(R.id.ftc_description);
...
//    loading.dismiss();
        ...
        //Defining the method
        if (getActivity()!=null) {
            api.otherRequest(new PrefManager(getActivity()).receivedSession(),"5",  //Creating an anonymous callback
